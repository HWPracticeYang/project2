...
namespace WindowsFormsApp1
{
    public partial class login : Form
    {
        ...
        {
            SqlConnection conn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Database1.mdf;Integrated Security=True;Connect Timeout=30");   //建立資料庫連線
            conn.Open();    //開啟資料庫連線
